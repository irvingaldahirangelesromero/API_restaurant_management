...
--> statement-breakpoint
CREATE TABLE "inventario_proveedor_producto" (
	"id" serial PRIMARY KEY NOT NULL,
	...
	CONSTRAINT "inventario_proveedor_producto_proveedor_id_producto_id_key" UNIQUE("proveedor_id","producto_id")
);
--> statement-breakpoint
...
CREATE TABLE "restaurante" (
	...
	"creado_en" timestamp with time zone DEFAULT now(),
	"actualizado_en" timestamp with time zone DEFAULT now(),
	"duracion_reserva_default" integer DEFAULT 90,
	"dias_confirmacion" integer DEFAULT 3
);
--> statement-breakpoint
...
ALTER TABLE "inventario_ordenes" ADD CONSTRAINT "inventario_ordenes_supplier_id_inventario_proveedores_id_fk" FOREIGN KEY ("supplier_id") REFERENCES "public"."inventario_proveedores"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventario_proveedor_producto" ADD CONSTRAINT "inventario_proveedor_producto_producto_id_fkey" FOREIGN KEY ("producto_id") REFERENCES "public"."inventario_productos"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "inventario_proveedor_producto" ADD CONSTRAINT "inventario_proveedor_producto_proveedor_id_fkey" FOREIGN KEY ("proveedor_id") REFERENCES "public"."inventario_proveedores"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
